...
- 先看 [tsconfig.json 全配置详解](/posts/工程化/tsconfig全配置详解)，建立 TypeScript 编译与类型边界
- 再看 [模块系统与路径别名](/posts/工程化/模块系统与路径别名)，理解模块解析为什么会影响 ESLint 报错
- 再看 [pnpm workspace 与 Monorepo 实战](/posts/工程化/pnpm-workspace与Monorepo实战)，理解共享配置包为什么值得抽出来
